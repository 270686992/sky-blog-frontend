<template>
  <div class="tag-container">
    ...
    <ul class="category-list">
      <nuxt-link tag="li" class="category-item" v-show="category.online" v-for="category in categories" :key="category.id" :to="`/category/${category.id}`">
        <div class="category-wrapper">
          <div class="category-image" :style="{backgroundImage: `url(${category.icon})`}"></div>
