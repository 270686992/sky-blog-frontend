  ...
  <div class="card-container">
    ...
    <div class="feature-wrapper">
      <article class="feature-content">
        <div class="feature-tag">{{showCategory(article.category_id)}}</div>
        ...
        <span class="feature-author">
          by&nbsp;
          <span class="author-name" @click.stop="navAuthor()">{{siteInfo.nickname}}</span>
...
export default {
  ...
  computed: {
    articleCover() {
      return this.article.cover_image ? this.article.cover_image : defaultCover
    }
  },
