  ...
  <div class="article-list-container">
    <div class="article-list-wrapper">
      <ul v-if="articles.length">
        <li class="article-item" v-show="article.publish_state" v-for="article in articles" :key="article.id">
          <article class="article-wrapper">
            <a class="category">{{showCategory(article.category_id)}}</a>
            ...
            <footer class="footer">
              <div class="author-wrapper">
                <div class="avatar-wrapper">
                  <span class="avatar" :style="{backgroundImage: `url(${siteInfo.author_avatar})`}"></span>
                </div>

                <div class="name-wrapper">
                      <span class="name">{{siteInfo.nickname}}</span>
                </div>
              </div>
              ...
              <div class="info-wrapper">
                ...
                <span class="count">{{article.comment_number}}</span>
          ...
          <div v-if="article.cover_image" class="split"></div>

          <img v-if="article.cover_image" class="article-image" :src="article.cover_image"/>
        </li>
      </ul>
...
<script>
import defaultAvatar from '@/assets/image/james.jpg'
