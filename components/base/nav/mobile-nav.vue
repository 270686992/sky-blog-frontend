      ...
      <div class="nav-list-wrapper" v-if="isShowMobileNav">
        ...
        <ul class="nav-list">
          ...
          <li class="nav-list-item" v-if="!isAuthenticated">
            <nuxt-link class="nav-link" tag="a" to="/register">注册</nuxt-link>
            <span class="nav-dot"></span>
          </li>

          <li class="nav-list-item" v-if="!isAuthenticated">
            <nuxt-link class="nav-link" tag="a" to="/login">登录</nuxt-link>
            <span class="nav-dot"></span>
          </li>

          <li class="nav-list-item" v-if="isAuthenticated">
            <nuxt-link class="nav-link" tag="a" to="/center">个人中心</nuxt-link>
            <span class="nav-dot"></span>
          </li>
        </ul>
      </div>
